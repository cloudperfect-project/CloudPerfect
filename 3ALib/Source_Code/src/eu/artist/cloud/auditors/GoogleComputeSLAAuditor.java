...
public class GoogleComputeSLAAuditor implements AuditingInterface {
	...
	public  void checkApplicabilityConditions(String provider,String user,String apiKey, String databaseIP, String DBuser, String DBkey) throws Exception {
		...
		apiKey=Files.toString(new File(apiKey), Charset.defaultCharset());
		...
		try {
			...
			try {
			    PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("pureGoogleComputeAPIcalls.txt", true)));
