...
public class TSharkHandler implements MonitoringCommandHandler{
	...
	public void commandStopper(){
		try {
			...
			UnixProcessUtils.killUnixProcess(commandExecutorDest.getProcess(), info.pass, "tshark");
...
//		    System.out.println("+++DEBUG - waited tshark commands SUCCESSFully");
...
//			System.out.println("+++DEBUG - tshark before writing");
