...
public class GetCapInfos {
	...
	public GetCapInfos(String pathToRes, String file, String pass, String label, boolean isOverwrite){
		try {
			this.proceed=false;
			...
			new ReadTSharkOutput(file, stdout, pathToRes+"TShark.txt", pathToRes, label, isOverwrite);
